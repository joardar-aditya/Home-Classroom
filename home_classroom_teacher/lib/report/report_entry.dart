...
class _stateReport extends State<report_entry> {
  ...
  void reportGiveMerit(reports model, String cl, String se) async{
  ...
  void reportGiveDeMerit(reports model,String cl, String se) async{
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    String code = sharedPreferences.getString("user");
    String teacher = sharedPreferences.getString("tcode");
    String school = sharedPreferences.getString("icode");
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
         ...
         Container(
              margin: EdgeInsets.all(10),
              child:Consumer2<performance_model, main_model>(builder:(context, model,model2, child){return TextField(
                onChanged: (s) {
                ...
                decoration: InputDecoration(
                    suffixIcon: InkWell(
                      onTap: () {
                        model.getStudents(search_s, model2.Classes, model2.section);
              ...
              Row(
                ...
                children: <Widget>[
                 ...
                 Consumer<main_model>(builder: (context, model, child) { return FittedBox(fit:BoxFit.contain,child:Padding(padding: EdgeInsets.symmetric(horizontal: 5),child:
                  ...
                  Consumer<main_model>(builder: (context, model, section) { return FittedBox(fit:BoxFit.contain,child:
          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                Center(
                  child:
                    Consumer2<reports, main_model>(builder:(context, model,model2, child){return RaisedButton(
                      padding: EdgeInsets.all(10),
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                      color: Colors_pack.color,
                      onPressed: () {
                        reportGiveMerit(model, model2.Classes, model2.section);
                      },
                ...
                Center(
                    ...
                    Consumer2<reports, main_model>(builder:(context, model,model2, child){return RaisedButton(
                        ...
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                        color: Colors_pack.color,
                        onPressed: () {reportGiveDeMerit(model, model2.Classes, model2.section);},
