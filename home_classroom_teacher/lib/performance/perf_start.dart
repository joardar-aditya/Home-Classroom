...
class _statePerf extends State<perf_start>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          Consumer2<performance_model,main_model>(builder: (context, model,model2, child){ return Container(
            margin: EdgeInsets.all(10),
            child:TextField(
              controller: control,
    decoration: InputDecoration(
      suffixIcon: InkWell(
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => performance_Search(model,control.text,model2.Classes, model2.section )));
        },
        child:Container(
          height:25,
          width: 25,
