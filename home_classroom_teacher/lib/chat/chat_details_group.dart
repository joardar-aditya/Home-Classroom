                ...
                child:ListView.builder(
                  ...
                  if(list_messages[ind].journ!=Student){
                    return Row(
                        ...
                        BorderRadius.circular(20)),child:Column( crossAxisAlignment:CrossAxisAlignment.start,children:[Text(list_messages[ind].sender, style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold, color: Colors.white ),),Text(list_messages[ind].text, style: TextStyle(fontSize: 16, color:Colors.white),)]))]);
                    ...
                    return Row(
                        ...
                        BorderRadius.circular(20)),child: Column(
                            ...
                            children:[Text(list_messages[ind].sender, style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold, color: Colors.white ),),Text(list_messages[ind].text, style: TextStyle(fontSize: 16, color: Colors.white),)]))]);
                  }
                  else{
                    return null;
                  }
...
class Messages_groups {
  String journ = "";
  String text = "";
  int sent_date = 0;
  String sender  = "";

  Messages_groups(this.text, this.journ, this.sender, this.sent_date);
}