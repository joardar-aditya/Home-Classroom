...
class _stateAbbu extends State<announce> {
        ...
        children: <Widget>[
          ...
          Container(
              ...
              child:Row(
                ...
                children: <Widget>[
                  SizedBox(
                    child:Consumer2<announce_model, main_model>(builder: (context, model,model2, child) {
                      return RaisedButton(
                        color:Colors_pack.color,
                      onPressed: () {
                          ...
                          makeAnnounce(model.atitle, model.announceFile, model.isGen, model2.Classes, model2.section);},
  ...
  void makeAnnounce(String s, File f, bool g, String clas, String sec) async {
    //TODO: Add the icode
    ...
    print(code);
    if(f == null){
      Uri uri = Uri.https("studie-server-dot-project-student-management.appspot.com", "/teacher/announce/$school/${clas}/${sec}/".toLowerCase() );
      print(uri.toString());
    ...
    Uri uri = Uri.https("studie-server-dot-project-student-management.appspot.com", "/teacher/announce/$school/${clas}/${sec}" );
