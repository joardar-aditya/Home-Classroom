...
class _stateI extends State<chat_details> {
  ...
  void getMessages() async {
    ...
    if (current == null) {
      ...
      updates = await ref
          .child("/teacher/" + teacher + "_" + school + "/contacts/students/" +
    ...
    appBar: AppBar(
      ...
      title: Column(
        ...
        children: <Widget>[
          ...
          Text((current==null)?"student":"Class " + current.Class+  " Sec " + current.section, maxLines: 1, style: TextStyle(fontSize: 16),)
              ...
              onTap: () async{
                ...
                if(current==null){
                  ...
                  DatabaseReference dat = await ref.child("/teacher/" +
                      teacher + "_" + school + "/contacts/students/" +
                      current.code + "_" + school + "/messages/");
                  String id = dat
                      .push()
                      .key;
                  ...
                  DatabaseReference dat_2 = await ref.child("/students/" +
