          ...
          child: Column(
            ...
            children: <Widget>[
              Flexible(
                ...
                child: Container(
                    height: 120.0,
                    child: Consumer<performance_model>(
                                  ...
                                  child: Center(
                                      child: Column(
                                        ...
                                        Container(
                                            ...
                                            child: Image(
                                              image: AssetImage(_images1[ind]),
                                              height: 70,
                                              width: 70,
                                            )),
                                        Container(
                                            child: Center(
                                          child: Text(_topics1[ind],
                                              style: TextStyle(
                                                  fontSize: 16.0,
              ...
              Flexible(
                flex: 2,
                child: Consumer<main_model>(builder: (context, model, child) {
                  return Container(
                    height: 130.0,
                              ...
                              child: Container(
                                  ...
                                  child: Center(
                                      child: Column(
                                        ...
                                        Container(
                                            child: Center(
                                          child: Text(model.perf_subjects[ind],
                                              style: TextStyle(
                                                  fontSize: 16.0,
                                                  fontWeight: FontWeight.w400)),
                                        )),
              ...
              Flexible(
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                              offset: Offset(5, 5), color: Colors.grey[200])
                        ],
                      ...
                      children: <Widget>[
                        Expanded(
                            ...
                            child: Container(
                              ...
                              style: TextStyle(
                                  color: Colors_pack.color, fontSize: 35.0),
                            )))),
                        Expanded(
                            flex: 2,
                            child:
                                Consumer2<performance_model, attendance_model>(
                      ...
                      children: <Widget>[
                        Flexible(
                            ...
                            child: Row(children: [
                              ...
                              Consumer<performance_model>(
                                  builder: (context, model, child) {
                                return Expanded(
                                    child: Text(
                                  model.Hw_sub.toString() + "%",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 20.0,
