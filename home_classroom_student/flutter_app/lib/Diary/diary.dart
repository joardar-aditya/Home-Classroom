            ...
            Container(
                  ...
                  Consumer<dairy_model>(builder:(context, model,child){ return (model.notes.isEmpty)?Container(child:Center(
                    ...
                    itemBuilder:(context, ind){
                      return (model.notes[ind].dateTime.month == _months.indexOf(_currentMonth) + 1 && model.notes[ind].dateTime.year.toString() == _currentYear )?Container(margin:EdgeInsets.all(20.0),height: 120.0,
                          child: Column(
