...
class _stateExam extends State<examOverview> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: (_loading)?Container(child:Center(child: CircularProgressIndicator(),)):Padding(
                ...
                return Consumer<exam_model>(builder:(context, model, child){return Container(
                    ...
                    child: RaisedButton(
                      onPressed: () async{
                        ...
                        bool value = await model.GetExams();
                        bool value2 = await model.GetPrevious(model.month, model.year);
                        print(value);
                        setState(() {
                           if(value){
                             _loading =false;
                        ...
                        children: <Widget>[
                          ...
                          DropdownButton<String>(
                            ...
                            onChanged: (String string) async {
                              ...
                              bool value = await model.GetPrevious(model.month, model.year);
                              if(value){
                              setState(() {
                                _loading = false;
                              });
                                ...
                                Scaffold.of(context).showSnackBar(SnackBar(content: Text("Problem loading Exams!"),));
                              }
                            },
                            underline: Container(),
                            iconSize: 0,
                          ...
                          DropdownButton<String>(
                            ...
                            onChanged: (String string) async{ _changeYear(string);
