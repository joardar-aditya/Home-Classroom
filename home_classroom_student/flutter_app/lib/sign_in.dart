...
class _sign_in_state extends State<sign_in> {
  ...
  void _changeState(String token, String s, String sccode, String pass) async {
    ...
    FirebaseMessaging().subscribeToTopic(sccode).then((value) => print("success")).catchError((error) => print("Not Subscribed"));
    //FirebaseAuth _auth = FirebaseAuth.instance;
    //final FirebaseUser user = (await _auth.signInWithCustomToken(token: token)).user;
